    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriaDeGastos", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CategoriaDeIngresos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriaDeIngresos", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CategoriaDePresupuestos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriaDePresupuestos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gastos_CategoriaDeGastos_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "CategoriaDeGastos",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingresos_CategoriaDeIngresos_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "CategoriaDeIngresos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
